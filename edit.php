...
<html>
  ...
  <body>
    <div class="container">
	  <h2>
	  Edit Nilai Pemrograman Framework
	  </h2>

      <table class="table table-bordered table-responsive">
        <form action="edit.php" method="POST" class="form-group row">
          <td>
            <input type="text" name="nim" value="'.$edit->NIM.'" class="form-control" placeholder="NIM" readonly>
          </td>
          <td>
...
$obj = new CRUD();
$upd = $obj->updateMhs($nim, $nama, $kelas, $nilai);
if($upd == "Success"){
