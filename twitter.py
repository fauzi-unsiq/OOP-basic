...
class TwitterClient(object):
    ...
    def __init__(self, query, retweets_only=False, with_sentiment=False):
        ...
        consumer_key = os.environ['CONSUMER_KEY'] = 'cIIE6Q1JX1U7jrvMgZY3BLz9v'
        consumer_secret = os.environ['CONSUMER_SECRET'] = 'LN2urHXC0mAL9PtZpevo1fQizfabDgvOzRcIntzLSxbAo6oqJf'
        access_token = os.environ['ACCESS_TOKEN'] = '586369666-s9DbpXTM5b3f3IBsDAPOUcvnm6LklIX8K5XJR1m5'
        access_token_secret = os.environ['ACCESS_TOKEN_SECRET'] = 'e0IW3BruUPK5LWonuY1Q9lkicO5QnQnIV90cGmPr1ZnxA'
